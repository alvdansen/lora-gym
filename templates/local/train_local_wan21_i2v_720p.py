"""
Wan 2.1 I2V 14B 720P LoRA Training — Local Edition
=====================================================
Trains a character identity LoRA against the Wan 2.1 Image-to-Video 720P
...
Usage:
  # Train with defaults
  python train_local_wan21_i2v_720p.py

  # Custom base directory (where setup_local.py put everything)
  python train_local_wan21_i2v_720p.py --base_dir D:/my_training

  # Custom dataset config
  python train_local_wan21_i2v_720p.py --dataset_config my_dataset.toml

  # Point to specific model files
  python train_local_wan21_i2v_720p.py --dit /path/to/dit.safetensors --clip /path/to/clip.pth

  # Resume from a specific checkpoint
  python train_local_wan21_i2v_720p.py --resume_from ./outputs/my-lora-e25.safetensors

  # Full custom config
  python train_local_wan21_i2v_720p.py --lr 5e-5 --dim 32 --alpha 32 --epochs 30

At inference: load your character LoRA in ComfyUI with the Wan 2.1 I2V 720P model.
"""
...
MODEL_FILENAMES = {
    "dit":    "wan2.1_i2v_720p_14B_bf16.safetensors",
...
def train(args):
    ...
    print("=" * 60)
    print(f"  Wan 2.1 I2V 14B 720P LoRA Training (Local)")
    print(f"  Output: {name}")
    ...
    # =================================================================
    print("\n" + "=" * 60)
    print(f"  Step 3: Training Wan 2.1 I2V 720P LoRA...")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Wan 2.1 I2V 14B 720P LoRA Training — Local Edition",
